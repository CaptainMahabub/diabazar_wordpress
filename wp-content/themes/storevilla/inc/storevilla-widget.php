...
class storevilla_promo_pages_area extends WP_Widget {
    ...
    **/
    public function __construct() {
        parent::__construct(
            'storevilla_promo_pages_area', 'SV: Promo Widget Section', array(
            'description' => __('A widget that promote you busincess visual way', 'storevilla')
        ));
    }
    ...
    private function widget_fields() {
        ...
        $fields = array( 
            ...
            'storevilla_promo_bg_image' => array(
                'storevilla_widgets_name' => 'storevilla_promo_bg_image',
                'storevilla_widgets_title' => __('Promo Full Background Image', 'storevilla'),
                'storevilla_widgets_field_type' => 'upload',
            ),
            
            'banner_start_group_left' => array(
                'storevilla_widgets_name' => 'banner_start_group_left',
                'storevilla_widgets_title' => __('Promo Section One', 'storevilla'),
                'storevilla_widgets_field_type' => 'group_start',
            ),
            
            'storevilla_promo_one_title' => array(
                'storevilla_widgets_name' => 'storevilla_promo_one_title',
                'storevilla_widgets_title' => __('Enter Promo One Title', 'storevilla'),
                'storevilla_widgets_field_type' => 'title',
            ),
            
            'storevilla_promo_one_desc' => array(
                'storevilla_widgets_name' => 'storevilla_promo_one_desc',
                'storevilla_widgets_title' => __('Enter Very Short Promo One Description', 'storevilla'),
                'storevilla_widgets_field_type' => 'textarea',
                'storevilla_widgets_row' => 3,
            ),
            
            'storevilla_promo_one_image' => array(
                'storevilla_widgets_name' => 'storevilla_promo_one_image',
                'storevilla_widgets_title' => __('Upload Promo One Image', 'storevilla'),
                'storevilla_widgets_field_type' => 'upload',
            ),
           
            'storevilla_promo_one_button_link' => array(
                'storevilla_widgets_name' => 'storevilla_promo_one_button_link',
                'storevilla_widgets_title' => __('Promo One Button Link', 'storevilla'),
                'storevilla_widgets_field_type' => 'url',
            ),

            'storevilla_promo_one_button_text' => array(
                'storevilla_widgets_name' => 'storevilla_promo_one_button_text',
                'storevilla_widgets_title' => __('Promo One Button Text', 'storevilla'),
                'storevilla_widgets_field_type' => 'text',
            ),
            
            'banner_end_group_left' => array(
                'storevilla_widgets_name' => 'banner_end_group_left',
            ...
            'banner_start_group_left_two' => array(
                ...
                'storevilla_widgets_title' => __('Promo Section Two', 'storevilla'),
                'storevilla_widgets_field_type' => 'group_start',
            ),
            
            'storevilla_promo_two_title' => array(
                'storevilla_widgets_name' => 'storevilla_promo_two_title',
                'storevilla_widgets_title' => __('Enter Promo Two Title', 'storevilla'),
                'storevilla_widgets_field_type' => 'title',
            ),
            
            'storevilla_promo_two_desc' => array(
                'storevilla_widgets_name' => 'storevilla_promo_two_desc',
                'storevilla_widgets_title' => __('Enter Very Short Promo Two Description', 'storevilla'),
                'storevilla_widgets_field_type' => 'textarea',
                'storevilla_widgets_row' => 3,
            ),
            
            'storevilla_promo_two_image' => array(
                'storevilla_widgets_name' => 'storevilla_promo_two_image',
                'storevilla_widgets_title' => __('Upload Promo Two Image', 'storevilla'),
                'storevilla_widgets_field_type' => 'upload',
            ),
           
            'storevilla_promo_two_button_link' => array(
                'storevilla_widgets_name' => 'storevilla_promo_two_button_link',
                'storevilla_widgets_title' => __('Promo Two Button Link', 'storevilla'),
                'storevilla_widgets_field_type' => 'url',
            ),

            'storevilla_promo_two_button_text' => array(
                'storevilla_widgets_name' => 'storevilla_promo_two_button_text',
                'storevilla_widgets_title' => __('Promo Two Button Text', 'storevilla'),
                'storevilla_widgets_field_type' => 'text',
            ),
            ...
            'banner_start_group_left_three' => array(
                ...
                'storevilla_widgets_title' => __('Promo Section Three', 'storevilla'),
                'storevilla_widgets_field_type' => 'group_start',
            ),
            
            'storevilla_promo_three_title' => array(
                'storevilla_widgets_name' => 'storevilla_promo_three_title',
                'storevilla_widgets_title' => __('Enter Promo Three Title', 'storevilla'),
                'storevilla_widgets_field_type' => 'title',
            ),
            
            'storevilla_promo_three_desc' => array(
                'storevilla_widgets_name' => 'storevilla_promo_three_desc',
                'storevilla_widgets_title' => __('Enter Very Short Promo Three Description', 'storevilla'),
                'storevilla_widgets_field_type' => 'textarea',
                'storevilla_widgets_row' => 3,
            ),
            
            'storevilla_promo_three_image' => array(
                'storevilla_widgets_name' => 'storevilla_promo_three_image',
                'storevilla_widgets_title' => __('Upload Promo Three Image', 'storevilla'),
                'storevilla_widgets_field_type' => 'upload',
            ),
           
            'storevilla_promo_three_button_link' => array(
                'storevilla_widgets_name' => 'storevilla_promo_three_button_link',
                'storevilla_widgets_title' => __('Promo Three Button Link', 'storevilla'),
                'storevilla_widgets_field_type' => 'url',
            ),

            'storevilla_promo_three_button_text' => array(
                'storevilla_widgets_name' => 'storevilla_promo_three_button_text',
                'storevilla_widgets_title' => __('Promo Three Button Text', 'storevilla'),
                'storevilla_widgets_field_type' => 'text',
            ),
    ...
    public function widget($args, $instance) {
        ...
        $promo_bg                 = $instance['storevilla_promo_bg_image'];
        
        $promo_one_title          = $instance['storevilla_promo_one_title'];
        $promo_one_desc           = $instance['storevilla_promo_one_desc'];
        $promo_one_image          = $instance['storevilla_promo_one_image'];
        $promo_one_button_link    = $instance['storevilla_promo_one_button_link'];
        $promo_one_text           = $instance['storevilla_promo_one_button_text'];
        
        $promo_two_title          = $instance['storevilla_promo_two_title'];
        $promo_two_desc           = $instance['storevilla_promo_two_desc'];
        $promo_two_image          = $instance['storevilla_promo_two_image'];
        $promo_two_button_link    = $instance['storevilla_promo_two_button_link'];
        $promo_two_text           = $instance['storevilla_promo_two_button_text'];
        
        $promo_three_title          = $instance['storevilla_promo_three_title'];
        $promo_three_desc           = $instance['storevilla_promo_three_desc'];
        $promo_three_image          = $instance['storevilla_promo_three_image'];
        $promo_three_button_link    = $instance['storevilla_promo_three_button_link'];
        $promo_three_text           = $instance['storevilla_promo_three_button_text'];


        echo $before_widget; 
    ?>
        <div class="promo-seciont" <?php if(!empty( $promo_bg )) { ?>style="background-image:url(<?php echo esc_url( $promo_bg ); ?>); background-size:cover;" <?php } ?>>
            ...
            <div class="store-container clearfix">
                ...
                <div class="promo-area">
                    ...
                    <div class="store-text-wrap">
                        ...
                        <?php if(!empty( $promo_one_text )) { ?>
                            <a href="<?php echo esc_url($promo_one_button_link ); ?>">
                                <button><?php echo esc_attr( $promo_one_text ); ?></button>
                            </a>
                        <?php } ?>
                    </div>

                    <?php if(!empty( $promo_one_image )) { ?>
                        <figure class="promo-image"><img src="<?php echo esc_url( $promo_one_image ); ?>"/></figure>
                    <?php } ?>
                </div>
                
                <div class="promo-area promo-two">
                     
                    <?php if(!empty( $promo_two_image )) { ?>
                        <figure class="promo-image"><img src="<?php echo esc_url( $promo_two_image ); ?>"/></figure>
                    <?php } ?>
                    ...
                    <div class="store-text-wrap">
                        ...
                        <?php if(!empty( $promo_two_text )) { ?>
                            <a href="<?php echo esc_url($promo_two_button_link ); ?>">
                                <button><?php echo esc_attr( $promo_two_text ); ?></button>
                            </a>
                        <?php } ?>
                    </div>
                </div>            
                ...
                <div class="promo-area">
                    ...
                    <div class="store-text-wrap">
                        ...
                        <?php if(!empty( $promo_three_text )) { ?>
                            <a href="<?php echo esc_url($promo_three_button_link ); ?>">
                                <button><?php echo esc_attr( $promo_three_text ); ?></button>
                            </a>
                        <?php } ?>
                    </div>

                    <?php if(!empty( $promo_three_image )) { ?>
                        <figure class="promo-image"><img src="<?php echo esc_url( $promo_three_image ); ?>"/></figure>
                    <?php } ?>
                </div>
                    ...
                    <div id="category-product-slider" class="product-cat-slide clearfix <?php echo $cat_aligment; ?>">
                        ...
                        <div class="home-block-inner">                                                
                            ...
                            <div class="block-title">
                                ...
                                <h2><?php echo esc_attr( $terms_name->name); ?></h2>
                            </div>
    ...
    **/
    ...
    public function widget($args, $instance) {
        ...
        **/
        ...
        $testimonial_category_list = $instance['testimonial_category_list'];
        $testimonial_bg_image      = $instance['storevilla_testimonial_bg_image'];
    ...
    ?>
        ...
        <div class="testimonial-outer-container" <?php if(!empty( $testimonial_bg_image )) { ?> style="background-image:url(<?php echo $testimonial_bg_image; ?>); background-size:cover;"<?php } ?>>
