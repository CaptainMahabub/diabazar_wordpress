...
Tags: e-commerce, news, custom-menu, one-column, two-columns, three-columns, left-sidebar, right-sidebar, custom-header, custom-colors, custom-background, threaded-comments, custom-menu, custom-header
...
A starter theme called Store Villa, or underscores.
...
** Update Overrides WooCommerce template in our theme and make theme compatible with latest version of WooCommerce (2.6.3).

= Version 1.0.0 - April 26 2016 =
** Initial release
...
* Font Awesome : Under MIT and GPL licenses http://fontawesome.io/license/

* lightslider : Copyright (c) 2015 Sachin N v1.1.5 - 2015-10-31 Under : MIT Licensed https://github.com/sachinchoolur/lightslider